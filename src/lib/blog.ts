...
export const POSTS: BlogPost[] = [
  {
    ...
    body: join(
      ...
      'This is why every serious tea brand uses some form of MET PET laminated structure. Atta can get away with 2-layer milky LDPE; tea cannot.',
      ...
      '### 50 g samples',
      'The trial size. Often free with a 250 g purchase, or sold in mixed-grade gift packs. Margin is low; print quality is what justifies the cost. A pre-made center-seal pouch on a 3-layer laminate works well here.',
      '### 100 g (entry)',
      ...
      '- A spot Pantone brand colour alongside CMYK (deep green, gold, sapphire blue)',
    ...
    faq: [
      {
        ...
        a: 'Tea aroma is a mix of volatile organic compounds that diffuse through ordinary plastic films within weeks. A 3-layer PET + MET PET + LDPE laminate provides an aroma, oxygen, light, and moisture barrier in a single structure.',
      },
      {
