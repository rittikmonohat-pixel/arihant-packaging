    ...
    <>
      ...
      <section className="container-x py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          {[
            { icon: FlaskConical, title: 'Incoming Material Inspection', desc: 'Every batch of PET, BOPP, LDPE, and ink is tested for thickness, COF, and food-safety compliance before it touches our line.' },
